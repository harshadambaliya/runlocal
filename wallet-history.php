...
<div class="rl-dashboard-menu mb-2">
    ...
    <div class="rl-dashboard-menu">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-walletHistory-tab" data-bs-toggle="tab" data-bs-target="#nav-walletHistory" type="button" role="tab" aria-controls="nav-walletHistory" aria-selected="true">wallet history</button>
    ...
    <div class="rl-dashboard-content">
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade show active" id="nav-walletHistory" role="tabpanel" aria-labelledby="nav-walletHistory-tab">
