...
<section class="rl-dashboard-section">
    ...
    <div class="rl-dashboard-menu">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-notification-tab" data-bs-toggle="tab" data-bs-target="#nav-notification" type="button" role="tab" aria-controls="nav-notification" aria-selected="true">Notification</button>
            </div>
        </nav>
    </div>
        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade show active" id="nav-notification" role="tabpanel" aria-labelledby="nav-notification-tab">
                <div class="rl-dashboard-content__inner">
                    <div class="rl-dashboard-editProfile-content"> 
                        <div class="rl-notification-content">
                            <div class="rl-notification__inner">
                                <a href="#" class="rl-notification-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nulla autem earum distinctio provident.</a>
                                <div class="rl-notification-time">
                                    <span>04:23 PM</span>
                                    <span>18 Oct 2021</span>
                                </div>
